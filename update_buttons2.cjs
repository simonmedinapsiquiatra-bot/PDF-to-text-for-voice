...
const targetStr2 = `<div class="grid grid-cols-3 sm:flex gap-2 w-full sm:w-auto">
...
const newStr2 = `<div class="grid grid-cols-2 sm:flex sm:flex-wrap gap-2 w-full sm:w-auto">
